...
var Calculator = (function () {
    ...
    Calculator.prototype.movingAverage = function () {
        ...
        $("#weightAvg").removeClass("btn btn-warning").addClass("btn btn-success");
    ...
    Calculator.prototype.weigthAverage = function () {
        ...
        $("#calculateWeight").click(function () {
            ...
            if (checksum != 1) {
                ...
                $("#methodMisc").append("<h4>Rezultat:</h4><h4>" + _this.monthName(_this.demandsCount < 12 ? _this.demandsCount + 1 : _this.demandsCount) + " = " + result + "</h4>");
            }
        });
    };
    ...
    Calculator.prototype.linearTrend = function () {
        ...
        $("#methodMisc").append("<h4>Srednji x = " + parseFloat(xAvg.toFixed(2)) + "</h4>\n\t\t\t<h4>  Srednji y = " + parseFloat(yAvg.toFixed(2)) + "</h4> \n\t\t\t<h4>Suma x*y = " + xySum + "</h4>\n\t\t\t<h4> Suma x*x = " + xxSum + "</h4>\n\t\t\t<h4> b = " + b + " </h4>\n\t\t\t<h4> a = " + a + " </h4>\n\t\t\t<h4> y = " + a + " + " + b + "x</h4>");
        var results = [];
